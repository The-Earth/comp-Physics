...
par5 = 1.2062604242433800E-01  # Orthogonal side -> bottom
# Absorption rate
a = 0.9
...
outbound = linalg.solve(coefficient_mat, constant_vec)  # Outbound flux
inbound = list(outbound[1:] / (1 - a))
inbound.insert(0, (outbound[0] - 1) / (1 - a))
print(f'Outbound: {outbound}\nInbound: {inbound}\nSum of Outbound / Sum of Inbound = {sum(inbound) / sum(outbound)}')
